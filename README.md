...
### 📝 Assignment notes
- *Assign the deadzone value for mouse to:  
  - `Deadzone`|`XDeadzone, YDeadzone`|  
  - `XleftDeadzone, XrightDeadzone, YleftDeadzone, YrightDeadzone`.  
- **Assign the deadzone value for analogs to:
  - `Deadzone`|`LSDeadzone, RSDeadzone`|`LSXDeadzone, LSYDeadzone, RSXDeadzone, RSYDeadzone`|  
